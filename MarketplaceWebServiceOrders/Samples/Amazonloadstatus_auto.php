...
$start=date('Y-m-d H:i:s',strtotime("$start - 12 hours"));  // -8 



$ss	 = "select * from ebay_account as a where a.ebay_user='$user' and AWS_ACCESS_KEY_ID != '' order by ebay_account desc ";
$ss				= $dbcon->execute($ss);
