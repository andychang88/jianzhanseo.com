...
$id_arr = array("104-1905488-5044250","104-6702529-4757838","002-9758055-2557836","109-9823607-5671466","103-6280884-1217066",
		"110-6838808-1056211","109-0467725-6063400","103-6192236-6364238");
...
function addLog($log,$type="1"){
 ...
 function countryname_change($Country){
  ...
  function filterSku($sku){
	...
	$pre_alpha = array("Q4","K11-","K22-","E11","E22","LK","GF","BOWUK01");
	foreach($pre_alpha as $key=>$val){
	      if(substr($sku,0,strlen($val))==$val ){
                     $sku = substr($sku,strlen($val));
              }
	}
        
        
                                if(substr($sku,0,2)=="XF" ){
                                    $sku = substr($sku,2);
                                }
