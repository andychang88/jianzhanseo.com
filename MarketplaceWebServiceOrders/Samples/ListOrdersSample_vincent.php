...
$account		= 'frankie201';
	...
	$cent = array('yansuxianzl888@gmail.com','eyiou168@gmail.com','everglcorpsales002@gmail.com');
foreach($cent as $account){
				$start		= date('Y-m-d H:i:s',strtotime("$cc -480 minutes"));
			$start		= date('Y-m-d',strtotime($start)).'T'.date('H:i:s',strtotime($start));
                 ...
                 //       echo("                Orders\n");
                       ...
                       //         echo("                            " . $order->getSellerOrderId() . "\n");
                            ...
                            if ($order->isSetOrderStatus()) 
                            {
							 ...
							 if($order->isSetAmazonOrderId() && $orderstatus == '805' ) 
                            {
