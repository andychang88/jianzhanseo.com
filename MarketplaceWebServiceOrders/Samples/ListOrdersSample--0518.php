...
for($i=0;$i<count($sql);$i++){
    ...
    //$account		= "yansuxianzl888@gmail.com"; //$_POST['account'];
                ...
                //        echo("                    " . $listOrdersResult->getCreatedBefore() . "\n");
                 ...
                 //       echo("                Orders\n");
                       ...
                       //         echo("                            " . $order->getSellerOrderId() . "\n");
                            ...
                            $CountryName=checkCountryName($Country);
...
function checkCountryName($name)
{
	$ar=array('Angola'=>'AO',
			...
			'Burkinafaso '=>'BF',
			'Bhutan '=>'BT',
			'Bosnia and heregoina '=>'BA',
			'Bouet Island '=>'B',
			'British indian ocean territor '=>'IO',
			'Burundi '=>'BI',
			'Christmas Island '=>'C',
			'Cape erde '=>'C',
			'Cameroon '=>'CM',
