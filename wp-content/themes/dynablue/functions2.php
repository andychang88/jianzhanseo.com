...
function my_ad(){
$html=<<<eof
<p><strong>亲爱的朋友，请访问我的淘宝小店支持一下：</strong></p>
<p><a target="_blank" href="http://2.taobao.com/item.htm?id=37482650916&spm=a1z10.1.w4004-2556539736.18.KoAgrm&mt=" title="我的淘宝（精品耳机）"><strong><span style="color: #ff0000;">我的淘宝小店(专卖精品耳机)</span><br>
</strong></a></p>
...
function custom_excerpt_length( $length ) {
	return 300;    //填写需要截取的字符数，1个汉字=2个字符
}
