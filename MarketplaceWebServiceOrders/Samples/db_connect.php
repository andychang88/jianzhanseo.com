...
class DBClass{
	...
	使用构造函数连接数据库
	**********************/
		//function __construct($host="localhost",$root="glbigsto_erp",$password="root@bigstore11",$dbname="glbigsto_erp"){
		function __construct($host="113.108.97.82",$root="glbigstore",$password="glbigstore@11",$dbname="v3-all"){
